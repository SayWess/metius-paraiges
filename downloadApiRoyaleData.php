...
//
//Actualisation des fichiers pour les nouveau joueur et de ceux qui sont partis et copie de ceux-ci
//
...
$dossier =  "JSON/compteurMAJ.json";
if(!is_dir($dossier)) {
	mkdir($dossier, 0777, true);
}

$compteurMAJ = file_get_contents("JSON/compteurMAJ.json");
$compteurMAJ = json_decode($compteurMAJ, true);

$compteurMAJ = date('H');

$compteurUpdate = file_put_contents("JSON/compteurMAJ.json", json_encode($compteurMAJ));
